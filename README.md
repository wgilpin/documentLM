...
- Node.js 18+ and npm (for building the frontend JS bundle)
- Docker (for PostgreSQL in dev, and for production deployment)
...
The Docker build compiles the JS bundle automatically — no local Node setup needed for production deploys.
