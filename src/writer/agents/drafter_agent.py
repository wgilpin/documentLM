...
_INSTRUCTION = (
    ...
    "in place of the selected passage. "
    "Ensure the replacement fits naturally with the surrounding content: "
    "match the tone, style, and structure "
    "(e.g. if the selection is a list item, keep the result consistent "
    "with the other items in that list)."
)
